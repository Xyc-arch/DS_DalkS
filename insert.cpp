...
int compareInsertC(bool dataW){
    ...
    // com-dblp parameter set
//    string file = "/mnt/data/yichen/data/com-dblp.ungraph.txt";
//    int startLine = 5;
//    int lineNum = 1049866;
//    int V = 425957;
//    bool fromZero = true;
    ...
    // live journal parameter set
    // string file = "/mnt/data/yichen/data/com-lj.ungraph.txt";
    // int startLine = 5;
    // int lineNum = 34681193;
    // int V=4036538;
    // bool fromZero = true;
    ...
    // com-YouTube parameter set
//    string file = "/mnt/data/yichen/data/com-youtube.ungraph.txt";
//    int startLine = 5;
//    int V = 1157827;
//    int lineNum = 2987628;
//    bool fromZero = false;
    ...
    // test
   string file = "/mnt/data/yichen/data/test.txt";
   int V = 16726;
   int startLine = 1;
   int lineNum = 95188;
   bool fromZero = false;
    ...
    // open-flight
//    string file = "/mnt/data/yichen/data/open-flight.txt";
//    int V = 7976;
//    int startLine = 1;
//    int lineNum = 30501;
    ...
    // lbimseti
//    string file = "/mnt/data/yichen/data/edges.csv";
//    int V = 220970;
//    int startLine = 2;
//    int lineNum = 17359347;
//    bool fromZero = false;
